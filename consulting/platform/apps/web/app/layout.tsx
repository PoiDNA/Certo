          ...
          <div className="max-w-[1280px] mx-auto px-6 md:px-20">
            ...
            <div className="border-t border-certo-accent/30 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex gap-6">
                <a href="/polityka" className="text-[11px] uppercase tracking-wider text-certo-muted hover:text-certo-accent transition-colors duration-300">Polityka prywatności</a>
                <a href="/regulamin" className="text-[11px] uppercase tracking-wider text-certo-muted hover:text-certo-accent transition-colors duration-300">Regulamin</a>
              </div>
            </div>
          </div>
        </footer>
