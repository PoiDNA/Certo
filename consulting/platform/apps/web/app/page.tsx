  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-b from-[#060D18] to-certo-primary pt-48 pb-32 md:pt-64 md:pb-48 overflow-hidden min-h-[90vh] flex items-center">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:40px_40px] opacity-10 pointer-events-none"></div>
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-certo-secondary/20 blur-[150px] rounded-full translate-x-1/3 -translate-y-1/4 pointer-events-none"></div>

        <div className="max-w-[1280px] mx-auto px-6 md:px-20 relative z-10 w-full">
          <div className="max-w-3xl animate-fade-in-up">
            <h1 className="font-display text-white text-5xl md:text-[72px] leading-[1.1] font-light tracking-[-0.02em] mb-10">
              Eksperckie doradztwo<br />na poziomie zarządu.
            </h1>
            <p className="text-certo-surface/80 text-lg md:text-xl leading-relaxed mb-12 max-w-2xl font-light">
              Łączymy akredytowanych doradców Certo z instytucjami wymagającymi 
              najwyższych standardów ładu korporacyjnego i zgodności regulacyjnej.
            </p>
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-20">
          ...
          <div className="max-w-4xl mb-20">
            <h2 className="font-display text-4xl md:text-5xl text-certo-primary font-light mb-10">
              Chcę porozmawiać z ekspertem ds.:
            </h2>
          ...
          <div className={`transition-all duration-500 ease-in-out overflow-hidden ${selectedArea ? 'max-h-[800px] opacity-100 mb-20' : 'max-h-0 opacity-0'}`}>
            <div className="bg-white p-10 md:p-12 border border-certo-border shadow-sm">
              <h3 className="text-xl md:text-2xl font-display text-certo-primary mb-8 font-light">
                Zostaw kontakt, abyśmy dobrali odpowiedniego doradcę z obszaru <span className="text-certo-accent font-bold">{selectedArea}</span>
              </h3>
              <div className="grid md:grid-cols-2 gap-6">
                <input type="text" placeholder="Imię i nazwisko" className="w-full p-4 border border-certo-border bg-certo-surface/30 focus:outline-none focus:border-certo-accent focus:bg-white transition-colors" />
                <input type="email" placeholder="Adres email (służbowy)" className="w-full p-4 border border-certo-border bg-certo-surface/30 focus:outline-none focus:border-certo-accent focus:bg-white transition-colors" />
                <input type="text" placeholder="Nazwa organizacji / Stanowisko" className="w-full p-4 border border-certo-border bg-certo-surface/30 focus:outline-none focus:border-certo-accent focus:bg-white transition-colors md:col-span-2" />
          ...
          <div className="mb-10">
            <h3 className="font-display text-3xl text-certo-primary font-light mb-10 border-b border-certo-border pb-4">
              Przykładowi eksperci z naszej sieci
            </h3>
                ...
                <div key={adv.id} className="group bg-white border border-certo-border hover:shadow-[0_12px_40px_rgba(0,0,0,0.06)] hover:-translate-y-1 transition-all duration-300 cursor-pointer flex flex-col h-full">
                  ...
                  <div className="p-8 flex-grow flex flex-col">
                    ...
                    <p className="text-sm text-certo-muted leading-relaxed mt-auto font-light">
                      Akredytowany doradca Certo z wieloletnim doświadczeniem w optymalizacji procesów dla strategicznych instytucji rynkowych.
                    </p>
                  </div>
                </div>
              ))}
