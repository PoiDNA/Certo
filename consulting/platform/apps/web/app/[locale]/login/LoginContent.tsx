    ...
    <div className="min-h-screen flex items-center justify-center bg-certo-primary px-4">
      <div className="w-full max-w-sm p-8 bg-white rounded-[8px] shadow-2xl border border-certo-border text-center">
        ...
        <div className="mt-8 flex justify-center gap-6">
          <a href="/polityka" className="text-xs text-certo-muted hover:text-certo-primary transition-colors">Polityka Prywatności</a>
          <a href="/regulamin" className="text-xs text-certo-muted hover:text-certo-primary transition-colors">Warunki Korzystania</a>
        </div>
      </div>
    </div>
  );
