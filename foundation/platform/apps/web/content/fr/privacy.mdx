...
Vous disposez des droits d'accès, de rectification, de suppression, de limitation du traitement, de portabilité des données et d'opposition.
Pour exercer vos droits : [privacy@certogov.org](mailto:privacy@certogov.org).
Vous avez également le droit de déposer plainte auprès de la Commission Nationale de l'Informatique et des Libertés (CNIL).
...
Données d'authentification — durant la période de possession du compte. Journaux techniques — 90 jours. Après suppression du compte, les données sont anonymisées dans les 30 jours.
