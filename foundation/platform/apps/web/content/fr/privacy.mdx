...
| Établir des statistiques | Art. 6, par. 1, lit. f RGPD |
...
Le service n'utilise que des cookies de session et d'authentification. Nous n'utilisons pas de cookies marketing ni de suivi.

## 7. Période de conservation

Données d'authentification — pendant la durée de votre compte. Journaux techniques — 90 jours. Après suppression du compte, les données sont anonymisées dans les 30 jours.
