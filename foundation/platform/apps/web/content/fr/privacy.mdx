...
Le responsable du traitement des données personnelles est la **Fondation Certo Governance Institute** domiciliée en Pologne.
...
Vous avez également le droit de déposer une plainte auprès du Président de la CNIL.
...
Les données d'authentification — pendant la durée du compte. Les journaux techniques — 90 jours. Après suppression du compte, les données sont anonymisées dans un délai de 30 jours.
