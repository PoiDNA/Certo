...
export async function PATCH(request: Request) {
  ...
  const { id, status, duplicate_of, ai_verified, ai_verification_notes, submission_count, process_status, rating_score } = body;
  ...
  if (process_status !== undefined) updates.process_status = process_status;
