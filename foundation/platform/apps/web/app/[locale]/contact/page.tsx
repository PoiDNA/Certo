    ...
    <div className="py-16 md:py-24 max-w-4xl mx-auto px-6">
      ...
      <div className="grid md:grid-cols-5 gap-12">
        <div className="md:col-span-2 space-y-6">
          <div>
            <h3 className="text-xs uppercase tracking-[0.15em] text-certo-gold font-semibold mb-2">{t('label_address')}</h3>
          ...
          <div>
            <h3 className="text-xs uppercase tracking-[0.15em] text-certo-gold font-semibold mb-2">{t('label_email')}</h3>
