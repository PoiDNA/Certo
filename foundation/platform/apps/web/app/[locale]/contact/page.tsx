    ...
    <div className="py-16 md:py-24 max-w-5xl mx-auto px-6">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-start">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg border border-certo-navy/5 p-6">
            ...
            <p className="text-sm text-certo-navy/70 leading-relaxed pl-[52px]">
          ...
          <div className="bg-white rounded-lg border border-certo-navy/5 p-6">
            ...
            <a href={`mailto:${t('email')}`} className="text-sm text-certo-navy/70 hover:text-certo-gold transition-colors pl-[52px] block">
              {t('email')}
            </a>
          </div>
        </div>
        ...
        {/* Form */}
        <div className="bg-white rounded-lg border border-certo-navy/5 p-8">
          <h2 className="text-xl font-serif font-bold text-certo-navy mb-6">{t('form_title')}</h2>
          <ContactForm />
        </div>
      </div>
    </div>
