          ...
          <footer className="bg-certo-navy border-t-[3px] border-certo-gold mt-auto">
            <div className="mx-auto max-w-6xl px-6 py-8 flex flex-col items-center justify-center text-center">
              ...
              <div className="flex gap-4 text-xs">
                <a href={`/${locale}/pp`} className="text-certo-gold hover:text-certo-gold-light transition-colors">Polityka Prywatności</a>
                <span className="text-certo-cream/40">•</span>
                <a href={`/${locale}/terms`} className="text-certo-gold hover:text-certo-gold-light transition-colors">Warunki Korzystania</a>
              </div>
            </div>
          </footer>
