...
function LoginContent() {
  ...
  const redirectTo = searchParams.get('redirectTo') || `/${locale}/docs`;
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-certo-cream font-serif px-4">
      <div className="bg-white border-[2px] border-certo-gold/30 rounded-lg p-10 w-full max-w-md text-center shadow-lg">
        <div className="mb-8">
          <img 
        ...
        <div className="flex flex-col gap-3 font-sans">
          <button onClick={() => handleOAuth('google')} className="flex items-center justify-center gap-3 px-6 py-3 border border-certo-navy/20 rounded-lg bg-white cursor-pointer text-sm font-semibold text-certo-navy w-full hover:bg-certo-navy/5 hover:border-certo-navy/40 transition-all">
