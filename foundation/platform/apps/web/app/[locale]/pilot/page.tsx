  ...
  return (
    <div className="w-full">
      ...
      <section className="max-w-4xl mx-auto px-6 pb-16 space-y-16">
        ...
        {/* Program description */}
        <div>
          <h2 className="text-2xl md:text-3xl font-serif font-bold text-certo-fg mb-4">{t('program_title')}</h2>
          <p className="text-base text-certo-fg-muted leading-relaxed">{t('program_description')}</p>
        </div>
        ...
        {/* Sectors */}
        <div>
          <h2 className="text-2xl md:text-3xl font-serif font-bold text-certo-fg mb-6">{t('form_sector')}</h2>
          <div className="grid md:grid-cols-3 gap-4">
            {(['public', 'corporate', 'ngo'] as const).map((sector) => (
              <div key={sector} className="bg-certo-surface p-5 border border-certo-card-border rounded-xl">
                <h3 className="font-serif font-bold text-certo-fg text-base mb-2">{t(`sector_${sector}`)}</h3>
                <p className="text-sm text-certo-fg-muted leading-relaxed">{t(`sector_${sector}_desc`)}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Benefits */}
        <div>
          <h2 className="text-2xl md:text-3xl font-serif font-bold text-certo-fg mb-6">{t('benefits_title')}</h2>
          <ul className="space-y-3">
            {([1, 3, 4] as const).map((i) => (
              <li key={i} className="flex items-start gap-3 text-base text-certo-fg-muted">
