...
const scores = [
  { key: 'score', icon: `${ICON_BASE}/Q1.png`, bg: 'from-certo-gold/10 to-transparent' },
  { key: 'vector', icon: `${ICON_BASE}/Q2.png`, bg: 'from-certo-navy/5 to-transparent' },
  { key: 'index', icon: `${ICON_BASE}/Q3.png`, bg: 'from-emerald-50 to-transparent' },
] as const;
