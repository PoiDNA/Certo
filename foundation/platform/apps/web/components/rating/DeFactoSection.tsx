...
export default function DeFactoSection() {
  ...
  return (
    <section ref={ref} className={`mb-20 reveal-base ${isVisible ? 'reveal-visible' : ''}`}>
      ...
      <p className="text-lg text-certo-fg-muted mb-10">
        {t('defacto_subtitle')}
      </p>

      <div className="grid md:grid-cols-2 gap-8 mb-12">
        {/* De iure */}
        <div className="bg-certo-surface p-8 border-l-4 border-certo-card-border rounded-lg">
          <h3 className="font-serif font-bold text-certo-fg text-lg mb-3">
            {t('defacto_iure')}
          </h3>
