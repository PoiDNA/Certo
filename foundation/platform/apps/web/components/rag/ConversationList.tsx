  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-3">
        <button
          onClick={onNewChat}
          className="w-full flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-300 text-sm text-gray-700 hover:bg-white hover:border-gray-400 transition-colors"
        >
