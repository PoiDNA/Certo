  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-certo-teal-darker">
      <div className="w-full max-w-sm p-8 bg-certo-card rounded-lg shadow-xl border border-certo-card-border text-center">
        ...
        {error === 'unauthorized' && (
          <div role="alert" className="mb-6 px-4 py-3 bg-red-50 border border-red-200 rounded-md text-sm text-red-700">
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            className="flex items-center justify-center gap-3 px-6 py-3 border border-certo-teal rounded-md bg-transparent cursor-pointer text-sm font-semibold text-certo-teal hover:bg-certo-teal hover:text-white transition-colors w-full"
